...
df_defenders_under_21.sort_values(by='Gls', ascending=False, inplace=True)\n
 df_defenders_under_21.head(5).to_html(index=False)
...
df_midfielders_under_21.sort_values(by='Gls', ascending=False, inplace=True)\n
 df_midfielders_under_21.head(5).to_html(index=False)
...
df_midfielders_over_30.sort_values(by='1/3', ascending=False, inplace=True)\n
 df_midfielders_over_30.head(5).to_html(index=False)
...
df_assist.head(1).to_html(index=False)
...
df_teams.head(1).to_html(index=False)
...
df_players.head(1).to_html(index=False)
