...
a = df_defenders_under_21.head(5).to_html(index=False)
...
a = df_midfielders_under_21.head(5).to_html(index=False)
...
a = df_midfielders_over_30.head(5).to_html(index=False)
...
a = df_assist.head(1).to_html(index=False)
...
a = df_teams.head(1).to_html(index=False)
...
a = df_players.head(1).to_html(index=False)
